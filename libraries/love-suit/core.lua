...
local NONE = {}
local default_theme = libRequire("love-suit", "theme")
...
function suit.new(theme)
	return setmetatable({
		...
		Button = libRequire("love-suit", "button"),
		ImageButton = libRequire("love-suit", "imagebutton"),
		Label = libRequire("love-suit", "label"),
		Checkbox = libRequire("love-suit", "checkbox"),
		Input = libRequire("love-suit", "input"),
		Slider = libRequire("love-suit", "slider"),

		layout = libRequire("love-suit", "layout").new(),
	}, suit)
end
